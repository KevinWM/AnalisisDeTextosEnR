...
namespace prograIA2
{
    public partial class Form1 : Form
    {
        ...
        private string identificarIdioma(string texto)
        {
            ...
            var identifier = factory.Load("E:/prograIA2/prograIA2/prograIA2/Core14.profile.xml");
        ...
        private void analizarCorreos(object sender, EventArgs e)
        {
            ...
            {
                engine.Initialize();
                engine.Evaluate("source('C:/Users/Jonathan/Desktop/proyectoIA/twiterR.r')");
            }
        }
        ...
        private void ejecutarScriptR(object sender, EventArgs e)
        {
            ...
            {
                engine.Initialize();
                engine.Evaluate("source('C:/Users/Jonathan/Desktop/proyectoIA/bayes.r')");
            }
        }
    }
}
